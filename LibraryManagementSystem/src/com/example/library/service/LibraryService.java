...
public class LibraryService {
	...
	public List<Book> availableBooks() {
		return inventoryService.availableBooks();
	}

	// Lending operations
	public boolean checkout(String isbn, String patronId, int days) {
		return inventoryService.checkout(isbn, patronId, days);
	}

	public boolean returnBook(String isbn) {
		return inventoryService.returnBook(isbn);
	}

	public void reserve(String isbn, String patronId) {
		inventoryService.reserve(isbn, patronId);
	}

	public List<Book> recommend(String patronId, int limit) {
		return inventoryService.recommendFor(patronId, limit);
	}
}
